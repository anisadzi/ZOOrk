...
int main() {
    ...
    Passage::createBasicPassage(start.get(), white_house.get(), "east", true, false, "");
    Passage::createBasicPassage(start.get(), cave_entrance.get(), "west", true, false, "");
    Passage::createBasicPassage(white_house.get(), south_of_white_house.get(), "south", true, false, "");
    Passage::createBasicPassage(south_of_white_house.get(), swamp.get(), "south", true, false, "");
    Passage::createBasicPassage(swamp.get(), south_of_white_house.get(), "north", true, false, "");
    Passage::createBasicPassage(south_of_white_house.get(), white_house.get(), "north", true, false, "");
    Passage::createBasicPassage(white_house.get(), north_of_white_house.get(), "north", true, false, "");
    Passage::createBasicPassage(north_of_white_house.get(), trick_tower.get(), "north", true, false, "");
    Passage::createBasicPassage(trick_tower.get(), monster_castle.get(), "east", true, false, "");
    Passage::createBasicPassage(monster_castle.get(), trick_tower.get(), "west", true, false, "");
    Passage::createBasicPassage(trick_tower.get(), north_of_white_house.get(), "south", true, false, "");
    Passage::createBasicPassage(north_of_white_house.get(), white_house.get(), "south", true, false, "");
    Passage::createBasicPassage(white_house.get(), east_of_white_house.get(), "east", true, false, "");
    Passage::createBasicPassage(east_of_white_house.get(), forest.get(), "east", true, false, "");
    Passage::createBasicPassage(forest.get(), east_of_white_house.get(), "west", true, false, "");
    Passage::createBasicPassage(east_of_white_house.get(), white_house.get(), "west", true, false, "");
    Passage::createBasicPassage(cave_entrance.get(), waterfall.get(), "south", true, false, "");
    Passage::createBasicPassage(waterfall.get(), first_door.get(), "south", true, false, "");
    Passage::createBasicPassage(first_door.get(), second_door.get(), "east", true, false, "");
    Passage::createBasicPassage(second_door.get(),  rainbow_road.get(), "east", true, true, "key");
    Passage::createBasicPassage(second_door.get(), first_door.get(), "west", true, false, "");
    Passage::createBasicPassage(first_door.get(), waterfall.get(), "north", true, false, "");
    Passage::createBasicPassage(waterfall.get(), cave_entrance.get(), "north", true, false, "");
    Passage::createBasicPassage(cave_entrance.get(), start.get(), "east", true, false, "");
